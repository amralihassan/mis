            ...
            <div class="row d-flex no-gutters">
                ...
                <div class="col-md-6 pl-md-5 py-md-5 ftco-animate">
                    <div class="heading-section pl-md-4 pt-md-5">
                        <span class="subheading">MEDICAL MANAGEMENT SYSTEM</span>

                    </div>
                    <div class="services-2 w-100 d-flex">

                        <div class="text pl-4">
                            <p> MEDICAL MANAGEMENT SYSTE Software for small to multi-location clinics. Rule-based
                                appointment scheduling, Out-sourcing, referral management, etc.</p>
