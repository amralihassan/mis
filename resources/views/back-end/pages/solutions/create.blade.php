...
@section('content')
    ...
    ['pagetitle'=>'Dashoard','title'=>'Create Solution'])

    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" novalidate method="POST" action="{{ route('solutions.store') }}"
                        enctype="multipart/form-data">
                        @csrf
                        @include('back-end.pages.solutions._form')

                        <hr>
                        <button class="btn btn-primary" type="submit">Save</button>
                        <button type="button" class="btn btn-light"
                            onclick="location.href='{{ route('solutions.index') }}';">
